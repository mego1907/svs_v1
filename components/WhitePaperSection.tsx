  ...
  return (
    <div className="mt-20 overflow-hidden">
      <div className="container">
        ...
        <p className="max-w-[70ch] text-center text-gray-100 mt-3 leading-7 text-base mx-auto ">
          Terms of service are rules by which one must agree to abide in order
          to use a service.
        </p>
        <p className="max-w-[70ch] text-center text-gray-100 leading-7 text-base mx-auto mb-2">
          Terms of service can also be merely a disclaimer, especially regarding
          the use of websites.
        </p>

        <div className="grid md:grid-cols-2 md:px-40 px-5 mt-20">
